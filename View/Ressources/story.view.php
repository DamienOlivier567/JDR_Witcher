        ...
        <div class="mb-5 mb-md-4">
            <div class="row">
                ...
                <div class="col-md col-md order-1 order-md-2">
                    ...
                    <p>
                        Acculés par l’armée nilfgaardienne, Traverser le pont qui enjambe le fleuve Pontar
                        est leur seul chance. Ce pont cependant gardé par un troll qui taxe tous les voyageurs...
        ...
        <div class="mb-5 mb-md-4">
            <div class="row">
                ...
                <div class="col-md col-md order-1 order-md-2">
                    <h3>La Strige</h3>
                    <p>
                        Un soir, alors que le groupe continuais son voyage via une grotte, il se senti comme surveillé.
        ...
        <div class="mb-5 mb-md-4">
            <div class="row">
                ...
                <div class="col-md col-md order-1 order-md-2">
                    ...
                    <p>
                        Les personnages joueurs arrivent sous des trombes d'eau dans un village esseulé non
        ...
        <div class="mb-5 mb-md-4">
            <div class="row">
                ...
                <div class="col-md col-md order-1 order-md-2">
                    ...
                    <p>
                        Les joueurs trouve un camp de résistant contre les envahisseurs Nilfgaardiens,
