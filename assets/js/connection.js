...
btnConnexion.addEventListener("click", function(e){
    ...
    else if(pseudo.value.length < 2 || pseudo.value.length > 50 || password.value.length < 4 || password.value.length > 60){
        e.preventDefault();
    ...
    if(acceptCB.checked === true){
        if(pseudoI.value === "" || passwordI.value === "" || passwordConfirmI.value === "" || emailI.value === ""){
            ...
            if(passwordI.value !== passwordConfirmI.value){
                ...
                || passwordI.value.length > 60 || passwordConfirmI.value.length < 6 || passwordConfirmI.value.length > 60){
                e.preventDefault();
